...
export class UserService {
	...
	updateUserLanguage(item: UserProfileLanguagePatch): Observable<UserServiceUser> {
	...
	updateUserProfile(item: UserServiceUserProfilePersist): Observable<UserServiceUser> {
