...
import { TenantRequestFilter } from '@app/core/query/tenant-request.lookup';

@Component({
	selector: 'app-tenant-listing-filters',
	templateUrl: './tenant-request-listing-filters.component.html',
	styleUrls: ['./tenant-request-listing-filters.component.scss']
})
export class TenantRequestListingFiltersComponent extends BaseComponent implements OnInit, OnChanges {

	@Input() filter: TenantRequestFilter;
	@Output() filterChange = new EventEmitter<TenantRequestFilter>();
	// panelExpanded = false;
	...
	//
	visibleFields(filter: TenantRequestFilter) {
