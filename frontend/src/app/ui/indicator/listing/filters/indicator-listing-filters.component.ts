...
@Component({
	selector: 'app-indicator-listing-filters',
	templateUrl: './indicator-listing-filters.component.html',
	styleUrls: ['./indicator-listing-filters.component.scss']
})
export class IndicatorListingFiltersComponent extends BaseComponent implements OnInit, OnChanges {
