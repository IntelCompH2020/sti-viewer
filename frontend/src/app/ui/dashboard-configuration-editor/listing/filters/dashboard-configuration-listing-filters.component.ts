...
import { IndicatorFilter } from '@app/core/query/indicator.lookup';

@Component({
	selector: 'app-dashboard-configuration-listing-filters',
	templateUrl: './dashboard-configuration-listing-filters.component.html',
	styleUrls: ['./dashboard-configuration-listing-filters.component.scss']
})
export class DashboardConfigurationListingFiltersComponent extends BaseComponent implements OnInit, OnChanges {

	@Input() filter: IndicatorFilter;
	@Output() filterChange = new EventEmitter<IndicatorFilter>();
	// panelExpanded = false;
