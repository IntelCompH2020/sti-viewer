...
public class NotificationCensor extends BaseCensor {
	private static final LoggerService logger = new LoggerService(LoggerFactory.getLogger(NotificationCensor.class));
	private final AuthorizationService authService;

	@Autowired
	public NotificationCensor(ConventionService conventionService, AuthorizationService authService) {
