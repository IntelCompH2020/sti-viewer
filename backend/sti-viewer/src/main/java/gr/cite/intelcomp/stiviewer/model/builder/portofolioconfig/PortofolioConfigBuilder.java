...
public class PortofolioConfigBuilder extends BaseBuilder<PortofolioConfig, PortofolioConfigEntity> {
	...
	public PortofolioConfigBuilder(QueryFactory queryFactory,
	...
	public List<PortofolioConfig> build(FieldSet fields, List<PortofolioConfigEntity> data) throws MyApplicationException {
		...
		List<PortofolioConfig> dataTreeConfigs = new ArrayList<>();
		...
		for (PortofolioConfigEntity d : data) {
			...
			if (fields.hasField(this.asIndexer(PortofolioConfig._code))) m.setCode(d.getCode());
			if (fields.hasField(this.asIndexer(PortofolioConfig._name))) m.setName(d.getName());
			...
			if (!columnFields.isEmpty() && d.getColumns() != null) m.setColumns(this.builderFactory.builder(PortofolioColumnConfigBuilder.class).authorize(this.authorize).build(columnFields, d.getColumns()));
