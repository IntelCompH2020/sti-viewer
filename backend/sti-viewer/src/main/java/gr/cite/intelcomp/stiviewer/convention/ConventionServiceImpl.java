package gr.cite.intelcomp.stiviewer.convention;
...
public class ConventionServiceImpl implements ConventionService {
    ...
    public String hashValue(Object value) throws MyApplicationException {
        ...
        if (value instanceof Instant)
            return String.format("%ts", (Instant) value);
    ...
    public String limit(String text, int maxLength) {
        ...
        if (text.length() > maxLength)
            return String.format("%s...", text.substring(0, maxLength));
        else return text;
    }
