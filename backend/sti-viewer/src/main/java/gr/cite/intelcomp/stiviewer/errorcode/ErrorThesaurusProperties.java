package gr.cite.intelcomp.stiviewer.errorcode;
...
public class ErrorThesaurusProperties {
	...
	private ErrorDescription bookmarkHashConflict;

	public ErrorDescription getBookmarkHashConflict() {
		return bookmarkHashConflict;
	}
