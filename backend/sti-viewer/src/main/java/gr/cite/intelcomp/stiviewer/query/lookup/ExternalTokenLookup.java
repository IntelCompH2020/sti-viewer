...
public class ExternalTokenLookup extends Lookup {
	...
	public ExternalTokenQuery enrich(QueryFactory queryFactory) {
		...
		if (this.expiresAtFrom != null) query.expiresAtFrom(this.expiresAtFrom);
		if (this.expiresAtTo != null) query.expiresAtTo(this.expiresAtTo);
		if (this.like != null) query.like(this.like);
		if (this.isActive != null) query.isActive(this.isActive);
		if (this.types != null) query.types(this.types);
		if (this.ids != null) query.ids(this.ids);
		if (this.tokens != null) query.tokens(this.tokens);
