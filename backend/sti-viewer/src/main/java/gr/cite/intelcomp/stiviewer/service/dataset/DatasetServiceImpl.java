...
public class DatasetServiceImpl implements DatasetService {
    ...
    public Dataset persist(DatasetPersist model, FieldSet fields) throws MyForbiddenException, MyValidationException, MyApplicationException, MyNotFoundException, InvalidApplicationException {
        ...
        if (isUpdate) {
            ...
            if (data == null)
                throw new MyNotFoundException(messageSource.getMessage("General_ItemNotFound", new Object[]{model.getId(), Dataset.class.getSimpleName()}, LocaleContextHolder.getLocale()));
        ...
        return this.builderFactory.builder(DatasetBuilder.class).build(BaseFieldSet.build(fields, Dataset._id, Dataset._hash), data);
    }
    ...
    public void deleteAndSave(UUID id) throws MyForbiddenException, InvalidApplicationException {
        ...
        this.deleterFactory.deleter(DatasetDeleter.class).deleteAndSaveByIds(Arrays.asList(id));
    }
}
