...
public class UserQuery extends QueryBase<UserEntity> {
    ...
    protected String fieldNameOf(FieldResolver item) {
        if (item.match(User._id))
            return UserEntity._id;
        else if (item.match(User._firstName))
            return UserEntity._firstName;
        else if (item.match(User._lastName))
            return UserEntity._lastName;
        else if (item.match(User._timezone))
            return UserEntity._timezone;
        else if (item.match(User._culture))
            return UserEntity._culture;
        else if (item.match(User._language))
            return UserEntity._language;
        else if (item.match(User._subjectId))
            return UserEntity._subjectId;
