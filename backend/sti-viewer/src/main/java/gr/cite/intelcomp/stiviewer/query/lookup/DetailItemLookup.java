...
public class DetailItemLookup extends Lookup {
    ...
    public List<UUID> getMasterItemIds() {
        return masterItemIds;
    }

    public void setMasterItemIds(List<UUID> masterItemIds) {
        this.masterItemIds = masterItemIds;
    }
    ...
    public DetailItemQuery enrich(QueryFactory queryFactory) {
        ...
        if (this.masterItemIds != null)
            query.masterItemIds(this.masterItemIds);
        if (this.masterItemSubQuery != null)
            query.masterItemSubQuery(this.masterItemSubQuery.enrich(queryFactory));
