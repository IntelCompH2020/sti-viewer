...
public class DetailItemQuery extends QueryBase<DetailItemEntity> {
    ...
    protected String fieldNameOf(FieldResolver item) {
        if (item.match(DetailItem._id))
            return DetailItemEntity._id;
        else if (item.match(DetailItem._name))
            return DetailItemEntity._name;
        else if (item.match(DetailItem._isActive))
            return DetailItemEntity._isActive;
        else if (item.match(DetailItem._createdAt))
            return DetailItemEntity._createdAt;
        else if (item.match(DetailItem._updatedAt))
            return DetailItemEntity._updatedAt;
        else if (item.match(DetailItem._hash))
            return DetailItemEntity._updatedAt;
        else if (item.match(DetailItem._master, MasterItemEntity._id))
            return DetailItemEntity._masterId;
        else if (item.prefix(DetailItem._master))
            return DetailItemEntity._masterId;
        else
            return null;
    }
